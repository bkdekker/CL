...
class BigramModel:
    ...
    def __init__(self, tokens):
        ...
        self.totalbigrams_smooth = self.count_total_smooth(self.bigrams)
    ...
    def count_total_smooth(self, freqdict):
        """
        Counts the total amount of items in a dataset by adding all frequencies.
        Returns the total as integer.
        """
    ...
    def p_smooth(self,w, w_n):
        ...
        #x = self.count_bigram_freqs(self.cleanlist)
